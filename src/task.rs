...
pub enum TaskStep {
    ...
    Git { action: String, args: Vec<String> }, // e.g., {"action":"commit","args":["-m","msg"]}
}
...
pub struct TaskRunner<'a> {
    ...
    pub ctx: HookContext,
    // You’ll inject closures to talk to your existing chat/tool/MCP layers:
        ...
        for step in &self.spec.steps {
            match step {
                ...
                TaskStep::Git { action, args } => {
                    // You can route via Exec("git", args) or via a dedicated git API.
